    ...
    return (
        <div className="mx-[8.5%] page">
            <div className="flex justify-between mt-[24px]">
                <div className="infoMain flex flex-col gap-[10px]">
                    <div className="flex flex-col gap-[10px]">
                        <div className="text-[24px] flex flex-col gap-0 textInfo">Devon Lane
            ...
            <div className="flex flex-col gap-[24px] mt-[64px]">
                <NavLink to='/account/history' className="px-[20px] h-[72px] stringLink flex justify-between items-center">
                ...
                <NavLink to='/account/status' className="px-[20px] h-[72px] stringLink flex justify-between items-center">
                    <div className="flex gap-[12px] items-center">
                        <div>

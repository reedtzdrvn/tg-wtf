...
const NotFound = () => {
    return(
        <div className={`${module.error} h-[100vh] xl:w-4/5`}>
            ...
            <svg className="w-[64px]" width="50" height="50" fill="none" stroke="#ff0000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
